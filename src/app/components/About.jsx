...
function About() {
  ...
  return (
    <section className='m-6 md:flex  md:justify-between'>
        <div className='my-6 md:w-1/2 '>
            <img src='https://cdn.pixabay.com/photo/2020/01/26/20/14/computer-4795762_960_720.jpg' alt='' className='md:w-2/3 md:h-full md:object-cover rounded'/>
        </div>
